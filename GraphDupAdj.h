#ifndef _GRAPH_DUP_ADJ_H_
#define _GRAPH_DUP_ADJ_H_

// Same as graph.h, except that member adj of structure Subgraph is a 2-D array that stores the list of neighbors for every resursive step.
...
typedef struct {
  ...
  unsigned **adj; // Truncated list of neighbors, one array per recursive step
